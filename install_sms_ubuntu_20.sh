...
#=========================================================================================================
# Program: install_sms_ubuntu_20.sh
#
# Ver         Date            Author          Comment
# =======     ===========     ===========     ==========================================
# V1.0.00     2020-06-19      DW              Install SMS on Ubuntu 20.04 with Apache web server.
...
then
  ...
  echo ""
  echo "This SMS installation program is specified for Ubuntu 20.04 only, running on other Linux distro is"
  echo "likely to fail."
  echo ""
...
if [[ "$tm" -eq 0 ]]
then
  apt-get -y install systemd-timesyncd > /tmp/sms_install.log
fi  
systemctl enable systemd-timesyncd >> /tmp/sms_install.log
systemctl restart systemd-timesyncd >> /tmp/sms_install.log
hwclock -w
...
snap install core
snap refresh core
echo "Install free SSL certificates auto renew utility"
#apt-get -y install certbot python3-certbot-apache >> /tmp/sms_install.log
