...
#=========================================================================================================
# Program: install_sms_alma8_nginx.sh
#
# Ver         Date            Author          Comment    
# =======     ===========     ===========     ==========================================
# V1.0.00     2021-02-04      DW              Install SMS server on AlmaLinux 8.3 by using Nginx as web server.
#=========================================================================================================
...
then
  ...
  echo ""
  echo "This SMS installation program is specified for AlmaLinux 8.x only, running on other Linux distro is"
  echo "likely to fail."
  echo ""
